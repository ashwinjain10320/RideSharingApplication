...
Use of proper abstraction, entity modeling, separation of concerns is required.
Code should be modular, readable and unit-testable.
Code should easily accommodate new requirements with minimal changes.
Proper exception handling is required.
TODO: Concurrency Handling (BONUS)

Sample Test Cases:
Input can be taken in any flexible way need not be exactly as shown below. 
Onboard 5 users
...
2(a) is the desired output
Find fuel saved
fuel_saved_by_passenger 
Nandini : 4 units, Gaurav : 10 units, Shashank:0, Rohan : 13
